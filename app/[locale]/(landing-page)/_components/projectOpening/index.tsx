...
const ProjectOpeningSection = () => {
    ...
    return (
        <section className='w-full flex flex-col gap-5 md:gap-10 justify-between items-center mx-auto px-4 md:px-12 py-5 md:py-10 bg-[#faebd7]'>
            <div className='max-w-[1440px] grid grid-cols-1 md:grid-cols-2 justify-between items-center'>
                <div className='flex flex-col justify-start items-start gap-5'>
                    <h1 className='text-black dark:text-white text-xl md:text-4xl font-semibold' style={{ lineHeight: "56px" }}>{t('homeProjectOpening.content')}</h1>
